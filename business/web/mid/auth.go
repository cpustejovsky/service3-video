...
import (
	...
	"github.com/cpustejovsky/service3-video/business/sys/validate"

	// v1Web "github.com/cpustejovsky/service3-video/business/web/v1"
...
func Authenticate(a *auth.Auth) web.Middleware {
	...
	m := func(handler web.Handler) web.Handler {
		...
		h := func(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
			...
			// Parse the authorization header.make
